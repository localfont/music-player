...
abstract class BatchEditorDialogFragment<T: BatchEditorView>: MvpAppCompatDialogFragment(), BatchEditorView {

    protected abstract fun createPresenter(): BatchEditorPresenter<T>

    protected abstract fun getInitialValue(): String
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if (savedInstanceState == null) {
            ViewUtils.setEditableText(binding.etInput, getInitialValue())
        }

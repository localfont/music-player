package com.github.anrimian.musicplayer.ui.common.progress
...
class ProgressView(
    ...
    private val progressBarPadding = context.getDimension(R.dimen.progress_bar_padding)
    private val progressStrokeWidth = context.getDimension(R.dimen.progress_stroke_width)
    private val iconPaddingExtra = context.getDimensionPixelSize(R.dimen.progress_icon_padding)
    private val strokeSize = context.getDimensionPixelSize(R.dimen.progress_outline_stroke_size)
